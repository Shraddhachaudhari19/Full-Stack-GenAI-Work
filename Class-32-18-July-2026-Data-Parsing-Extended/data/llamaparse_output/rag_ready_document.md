...
<table>
  ...
  <tbody>
    <tr>
        <td>Contracts</td>
<td>Dense legal text, clause numbers, cross<br/>references</td>
<td>Need section-aware chunks and citations</td>
    </tr>
<tr>
        <td>Tables</td>
<td>Merged headers, numeric columns,<br/>footnotes</td>
<td>Need row/column preservation</td>
    </tr>
<tr>
        <td>Images</td>
<td>Architecture diagram, heatmap, scanned<br/>form</td>
<td>Need OCR or multimodal extraction</td>
    </tr>
<tr>
        <td>Multi-tenant metadata</td>
<td>client_id, document_id,<br/>contract_group_id</td>
...
```mermaid
graph LR
    subgraph TenantSafeZone [Red boundary = tenant-safe processing zone. Retrieval authenticated client_id before LLM context creation.]
        direction LR
    ...
    style CU fill:#FFFFFF,stroke:#4682B4,stroke-width:1px
    style SOS fill:#FFFFFF,stroke:#4682B4,stroke-width:1px
    style IW fill:#FFFFFF,stroke:#4682B4,stroke-width:1px
    style VN fill:#FFFFFF,stroke:#4682B4,stroke-width:1px
    style AS fill:#FFFFFF,stroke:#4682B4,stroke-width:1px
    style QR fill:#FFFFFF,stroke:#4682B4,stroke-width:1px
    style LG fill:#FFFFFF,stroke:#4682B4,stroke-width:1px
    style CU_meta fill:#FFFACD,stroke:#DEB887
    style SOS_meta fill:#FFFACD,stroke:#DEB887
    style VN_meta fill:#FFFACD,stroke:#DEB887
    style AS_meta fill:#FFFACD,stroke:#DEB887
    style LG_meta fill:#FFFACD,stroke:#DEB887
```
...
Portrait of a smiling man with a beard, wearing a red and blue plaid shirt, with arms crossed against a bright yellow background.
